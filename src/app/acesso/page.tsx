  ...
  if (!access) {
    return (
      <main className="mx-auto flex min-h-screen max-w-xl flex-col items-center justify-center gap-4 px-6 text-center">
        <h1 className="text-2xl font-semibold text-neutral-900">Accesso non trovato</h1>
        ...
        <Link href="/" className="rounded-md bg-neutral-900 px-4 py-2 text-white">
          Torna alla home
        </Link>
      </main>
    );
  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-12">
      <header className="mb-10 text-center">
        <h1 className="text-3xl font-bold text-neutral-900">Il tuo Kit Incassa</h1>
        ...
        {categories.map((category) => {
          ...
          return (
            <section key={category.slug}>
              <h2 className="mb-3 text-lg font-semibold text-neutral-900">{category.name}</h2>
